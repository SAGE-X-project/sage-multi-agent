...
PLANNING_PORT="${PLANNING_AGENT_PORT:-19081}"
MEDICAL_PORT="${MEDICAL_AGENT_PORT:-19082}"
PAYMENT_AGENT_PORT="${PAYMENT_AGENT_PORT:-19083}"   # payment agent runs as a separate process
GATEWAY_PORT="${GATEWAY_PORT:-5500}"

# All listeners we want to clear
PORTS=(
  "$CLIENT_PORT" "$ROOT_PORT"
  "$PLANNING_PORT" "$MEDICAL_PORT" "$PAYMENT_AGENT_PORT"
  "$GATEWAY_PORT" 
)
